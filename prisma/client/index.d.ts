...
export namespace Prisma {
  ...
  */
	...
	> = {
		...
		meta: {
			modelProps: "player" | "game" | "save" | "gameState";
			...
			Player: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<PlayerCountAggregateOutputType>
							| number;
					};
				};
			};
			Game: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<GameCountAggregateOutputType>
							| number;
					};
				};
			};
			Save: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<SaveCountAggregateOutputType>
							| number;
					};
				};
			};
			GameState: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<GameStateCountAggregateOutputType>
							| number;
					};
				};
			};
	 ...
	 * PlayerCountOutputType without action
	 */
	export type PlayerCountOutputTypeCountGamesArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
	 ...
	 * GameCountOutputType without action
	 */
	export type GameCountOutputTypeCountSavesArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		...
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<PlayerGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof PlayerGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
	...
	export type PlayerOmit<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetOmit<
		"id" | "name" | "username" | "admin" | "lastPlayed" | "createdAt",
		ExtArgs["result"]["player"]
	>;
	...
	> {
		...
		>(
			args: SubsetIntersection<T, PlayerGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	> extends Prisma.PrismaPromise<T> {
		...
		games<T extends Player$gamesArgs<ExtArgs> = {}>(
			args?: Subset<T, Player$gamesArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
	...
	type GetGameGroupByPayload<T extends GameGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<GameGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof GameGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
	...
	> {
		...
		>(
			args: SubsetIntersection<T, GameGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	> extends Prisma.PrismaPromise<T> {
		...
		player<T extends PlayerDefaultArgs<ExtArgs> = {}>(
			...
			GlobalOmitOptions
		>;
		saves<T extends Game$savesArgs<ExtArgs> = {}>(
			args?: Subset<T, Game$savesArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
	...
	type GetSaveGroupByPayload<T extends SaveGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<SaveGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof SaveGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
	...
	export type SaveOmit<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetOmit<
		"id" | "gameId" | "time" | "auto" | "stateId" | "createdAt",
		ExtArgs["result"]["save"]
	>;
	...
	> = $Result.GetResult<Prisma.$SavePayload, S>;
	...
	> {
		...
		createManyAndReturn<T extends SaveCreateManyAndReturnArgs>(
			args?: SelectSubset<T, SaveCreateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$SavePayload<ExtArgs>,
				T,
		...
		updateManyAndReturn<T extends SaveUpdateManyAndReturnArgs>(
			args: SelectSubset<T, SaveUpdateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$SavePayload<ExtArgs>,
				T,
		...
		aggregate<T extends SaveAggregateArgs>(
			args: Subset<T, SaveAggregateArgs>,
		...
		>(
			args: SubsetIntersection<T, SaveGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	> extends Prisma.PrismaPromise<T> {
		...
		game<T extends GameDefaultArgs<ExtArgs> = {}>(
			...
			GlobalOmitOptions
		>;
		state<T extends Save$stateArgs<ExtArgs> = {}>(
			args?: Subset<T, Save$stateArgs<ExtArgs>>,
		): Prisma__GameStateClient<
			$Result.GetResult<
	...
	> = {
		 ...
		 */
		orderBy?:
			| GameStateOrderByWithRelationInput
			| GameStateOrderByWithRelationInput[];
		/**
		 * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
		 *
	...
	> = {
		where?: GameStateWhereInput;
		orderBy?:
			| GameStateOrderByWithAggregationInput
			| GameStateOrderByWithAggregationInput[];
		...
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<GameStateGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof GameStateGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
	...
	type GameStateGetPayload<
		S extends boolean | null | undefined | GameStateDefaultArgs,
	> = $Result.GetResult<Prisma.$GameStatePayload, S>;

	type GameStateCountArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = Omit<
		GameStateFindManyArgs,
	...
	> {
		...
		createManyAndReturn<T extends GameStateCreateManyAndReturnArgs>(
			args?: SelectSubset<T, GameStateCreateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$GameStatePayload<ExtArgs>,
				T,
		...
		updateManyAndReturn<T extends GameStateUpdateManyAndReturnArgs>(
			args: SelectSubset<T, GameStateUpdateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$GameStatePayload<ExtArgs>,
				T,
		...
		count<T extends GameStateCountArgs>(
			...
			T extends $Utils.Record<"select", any>
				? T["select"] extends true
					...
					: GetScalarType<
							T["select"],
							GameStateCountAggregateOutputType
						>
				: number
		>;
		...
		aggregate<T extends GameStateAggregateArgs>(
			args: Subset<T, GameStateAggregateArgs>,
		...
		>(
			args: SubsetIntersection<T, GameStateGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	> extends Prisma.PrismaPromise<T> {
		readonly [Symbol.toStringTag]: "PrismaPromise";
		save<T extends SaveDefaultArgs<ExtArgs> = {}>(
			args?: Subset<T, SaveDefaultArgs<ExtArgs>>,
		): Prisma__SaveClient<
			| $Result.GetResult<
					Prisma.$SavePayload<ExtArgs>,
					T,
	...
	> = {
		 ...
		 */
		data: XOR<
			GameStateUpdateManyMutationInput,
			GameStateUncheckedUpdateManyInput
		>;
		/**
	...
	export type SaveWhereInput = {
		...
		state?: XOR<
			GameStateNullableScalarRelationFilter,
			GameStateWhereInput
		> | null;
	};
	...
	export type GameStateScalarWhereWithAggregatesInput = {
		AND?:
			| GameStateScalarWhereWithAggregatesInput
			| GameStateScalarWhereWithAggregatesInput[];
	...
	export type JsonFilter<$PrismaModel = never> =
		| PatchUndefined<
				Either<
					...
					Exclude<
						keyof Required<JsonFilterBase<$PrismaModel>>,
						"path"
					>
				>,
				Required<JsonFilterBase<$PrismaModel>>
	...
	export type SaveCreateNestedManyWithoutGameInput = {
		create?:
			| XOR<
					SaveCreateWithoutGameInput,
					SaveUncheckedCreateWithoutGameInput
			  >
			| SaveCreateWithoutGameInput[]
			| SaveUncheckedCreateWithoutGameInput[];
		connectOrCreate?:
			| SaveCreateOrConnectWithoutGameInput
			| SaveCreateOrConnectWithoutGameInput[];
	...
	export type PlayerUpdateOneRequiredWithoutGamesNestedInput = {
		...
		update?: XOR<
			XOR<
				PlayerUpdateToOneWithWhereWithoutGamesInput,
	...
	export type SaveUpdateManyWithoutGameNestedInput = {
		...
		connectOrCreate?:
			...
			| SaveCreateOrConnectWithoutGameInput[];
		upsert?:
			| SaveUpsertWithWhereUniqueWithoutGameInput
			| SaveUpsertWithWhereUniqueWithoutGameInput[];
		createMany?: SaveCreateManyGameInputEnvelope;
		...
		connect?: SaveWhereUniqueInput | SaveWhereUniqueInput[];
		update?:
			| SaveUpdateWithWhereUniqueWithoutGameInput
			| SaveUpdateWithWhereUniqueWithoutGameInput[];
		updateMany?:
			| SaveUpdateManyWithWhereWithoutGameInput
			| SaveUpdateManyWithWhereWithoutGameInput[];
	...
	export type GameCreateNestedOneWithoutSavesInput = {
		create?: XOR<
			GameCreateWithoutSavesInput,
			GameUncheckedCreateWithoutSavesInput
		>;
	...
	export type GameStateCreateNestedOneWithoutSaveInput = {
		create?: XOR<
			GameStateCreateWithoutSaveInput,
			GameStateUncheckedCreateWithoutSaveInput
		>;
	...
	export type GameUpdateOneRequiredWithoutSavesNestedInput = {
		...
		update?: XOR<
			XOR<
				GameUpdateToOneWithWhereWithoutSavesInput,
				GameUpdateWithoutSavesInput
			>,
			GameUncheckedUpdateWithoutSavesInput
		>;
	};
	...
	export type GameStateUpdateOneWithoutSaveNestedInput = {
		...
		update?: XOR<
			XOR<
				GameStateUpdateToOneWithWhereWithoutSaveInput,
				GameStateUpdateWithoutSaveInput
			>,
			GameStateUncheckedUpdateWithoutSaveInput
		>;
	};
	...
	export type SaveCreateNestedOneWithoutStateInput = {
		create?: XOR<
			SaveCreateWithoutStateInput,
			SaveUncheckedCreateWithoutStateInput
		>;
	...
	export type SaveUpdateOneRequiredWithoutStateNestedInput = {
		...
		update?: XOR<
			XOR<
				SaveUpdateToOneWithWhereWithoutStateInput,
				SaveUpdateWithoutStateInput
			>,
			SaveUncheckedUpdateWithoutStateInput
		>;
	};
	...
	export type GameUpsertWithWhereUniqueWithoutPlayerInput = {
		where: GameWhereUniqueInput;
		update: XOR<
			GameUpdateWithoutPlayerInput,
			GameUncheckedUpdateWithoutPlayerInput
		>;
		create: XOR<
			GameCreateWithoutPlayerInput,
			GameUncheckedCreateWithoutPlayerInput
	...
	export type GameUpdateManyWithWhereWithoutPlayerInput = {
		...
		data: XOR<
			...
			GameUncheckedUpdateManyWithoutPlayerInput
		>;
	};
	...
	export type SaveUpsertWithWhereUniqueWithoutGameInput = {
		where: SaveWhereUniqueInput;
		update: XOR<
			SaveUpdateWithoutGameInput,
			SaveUncheckedUpdateWithoutGameInput
		>;
		create: XOR<
			SaveCreateWithoutGameInput,
			SaveUncheckedCreateWithoutGameInput
	...
	export type SaveUpdateManyWithWhereWithoutGameInput = {
		...
		data: XOR<
			...
			SaveUncheckedUpdateManyWithoutGameInput
		>;
	};
